...
listInsert(Elt head, int dir, Elt e)
{
	...
	/* make neighbors point back at e */
	e->next[dir]->next[!dir] = e;
	e->next[!dir]->next[dir] = e;
}

/* split a list, removing all elements between e1 and e2 */
/* e1 is the left most node of the removed subsequence, e2 rightmost */
...
/* splice a list starting a t e2 after e1 */
...
/* Amazingly, thi sis guaranteed to abort or return no matter
 * how badly screwed up to list is. */
void
